...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-[#071923]/75 via-[#071923]/30 to-[#071923]/85" />

      <div className="absolute inset-0 bg-gradient-to-t from-[#071923]/90 via-transparent to-transparent" />

      {/* Subtle navy colour treatment */}
      <div className="absolute inset-0 bg-[#071923]/20 mix-blend-multiply" />

      {/* Subtle luxury vignette */}
      <div className="pointer-events-none absolute inset-0 [box-shadow:inset_0_0_180px_60px_rgba(7,25,35,0.75)]" />
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-5 pt-20 pb-28 text-center text-white sm:px-6 md:pt-24 md:pb-32 lg:pb-36">
        <div className="max-w-5xl">
          ...
          <div className="mb-5 flex items-center justify-center gap-3 opacity-0 animate-fade-up [animation-delay:0.1s] sm:mb-6 sm:gap-4">
            <span className="h-px w-8 bg-[#b99a63]/70 sm:w-10" />
          ...
          <h1 className="text-4xl font-light leading-[1.08] tracking-tight opacity-0 animate-fade-up [animation-delay:0.25s] sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl">
            ...
            <span className="bg-gradient-to-r from-white via-[#f8f5ee] to-[#b99a63] bg-clip-text font-normal text-transparent">
              Arabian Queen
            </span>
          </h1>
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 opacity-0 animate-fade-up [animation-delay:0.55s] sm:mt-11 sm:flex-row sm:gap-4">
            ...
            <a
              href="#about"
              className="group inline-flex items-center gap-2.5 border border-[#b99a63] bg-[#b99a63] px-6 py-3.5 text-[11px] uppercase tracking-[0.18em] text-[#071923] transition-all duration-300 hover:bg-transparent hover:text-[#b99a63] sm:px-8 sm:py-4 sm:text-xs sm:tracking-[0.2em]"
            >
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-2.5 border border-[#b99a63]/60 bg-[#071923]/20 px-6 py-3.5 text-[11px] uppercase tracking-[0.18em] text-white backdrop-blur-sm transition-all duration-300 hover:border-[#b99a63] hover:bg-[#b99a63]/10 hover:text-[#b99a63] sm:px-8 sm:py-4 sm:text-xs sm:tracking-[0.2em]"
            >
              Get in Touch
            </a>
          </div>
          ...
          {/* Stats strip */}
          <div className="mx-auto mt-12 grid max-w-xl grid-cols-3 gap-4 border-t border-[#b99a63]/30 pt-6 opacity-0 animate-fade-up [animation-delay:0.7s] sm:mt-16 sm:max-w-2xl sm:gap-8 sm:pt-8">
            ...
            {[
              ...
              <div key={stat.label}>
                ...
                <p className="mt-0.5 text-[9px] uppercase tracking-[0.2em] text-white/65 sm:mt-1 sm:text-[10px] sm:tracking-[0.25em]">
                  {stat.label}
                </p>
              </div>
            ))}
      ...
      <div className="absolute bottom-5 left-1/2 z-10 -translate-x-1/2 text-white sm:bottom-6 md:bottom-8">
        <div className="flex flex-col items-center gap-2.5 sm:gap-3">
          ...
          <span className="text-[9px] uppercase tracking-[0.28em] text-[#b99a63]/85 sm:text-[10px] sm:tracking-[0.3em]">
            Scroll
          </span>
